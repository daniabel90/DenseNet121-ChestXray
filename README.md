# DenseNet121 — Pediatric Chest X-Ray Classification
...
[![Stars](https://img.shields.io/github/stars/daniabel90/DenseNet121-ChestXray?style=flat)](https://github.com/daniabel90/DenseNet121-ChestXray)
...
Dense connectivity architecture encouraging feature reuse for parameter-efficient medical imaging.

Each layer receives input from all preceding layers — originally used in the landmark CheXNet paper for chest X-ray diagnosis.
...
|----------|-------|
| **Model** | DenseNet121 |
| **Layers** | 121 layers with dense connectivity |
...
```
DenseNet121-ChestXray/
├── 📓 densenet121_chest_xray.ipynb    ← Full training + evaluation notebook
...
```bash
# 1. Clone
git clone https://github.com/daniabel90/DenseNet121-ChestXray.git
cd DenseNet121-ChestXray
...
# 4. Launch notebook
jupyter notebook densenet121_chest_xray.ipynb
```
